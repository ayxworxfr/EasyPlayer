...
//import com.evildoer.player.ui.main.MainActivity;
//
...
//        return mPlayer.getPlayingVideo();
//    }
//
//    @Override
...
//
//    @Override
//    public void onSwitchLast(@Nullable Video last) {
//        showNotification();
//    }
//
//    @Override
//    public void onSwitchNext(@Nullable Video next) {
//        showNotification();
//    }
//
//    @Override
//    public void onComplete(@Nullable Video next) {
//        showNotification();
//    }
//
//    @Override
...
//        Video currentVideo = mPlayer.getPlayingVideo();
//        if (currentVideo != null) {
//            remoteView.setTextViewText(R.id.text_view_name, currentVideo.getDisplayName());
//            remoteView.setTextViewText(R.id.text_view_artist, currentVideo.getArtist());
//        }
...
//        Bitmap album = AlbumUtils.parseAlbum(getPlayingVideo());
//        if (album == null) {
